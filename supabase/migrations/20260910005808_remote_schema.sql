...
CREATE POLICY "Produtos podem ser visualizados publicamente" ON "public"."produtos"
  FOR SELECT
  TO "anon"
  USING (true);
...
GRANT MAINTAIN, REFERENCES, SELECT, TRIGGER, TRUNCATE ON TABLE "public"."produtos" TO "anon";

REVOKE ALL ON TABLE "public"."produtos" FROM "authenticated";

GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE "public"."produtos" TO "authenticated";

REVOKE ALL ON TABLE "public"."produtos" FROM "service_role";

GRANT MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE "public"."produtos" TO "service_role";
